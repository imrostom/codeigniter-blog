        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="<?php echo base_url()?>Admin/index"><span>Metro</span></a>
                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            <li><a href="<?php echo base_url()?>Admin/index"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>	
                            <li><a href="<?php echo base_url()?>Category/add_category"><i class="icon-envelope"></i><span class="hidden-tablet"> Add Category</span></a></li>
                            ...
                            <li><a href="<?php echo base_url()?>Post/add_post"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Post</span></a></li>
                           
                            <li><a href="<?php echo base_url()?>Post/manage_post"><i class="icon-edit"></i><span class="hidden-tablet"> Manage Post</span></a></li>
                            <li><a href="<?php echo base_url()?>ThemeOption/add_option"><i class="icon-list-alt"></i><span class="hidden-tablet"> Theme Option</span></a></li>
                           </ul>
                    </div>
                </div>
                <!-- end: Main Menu -->
